...
var routes = [
    {
        ...
        handle: function (req, res, next) {
            ...
            res.end(JSON.stringify([
                {name:'艾一一',avatar:'../assets/head.jpg',id:'key1',phonetic:'AiYiYi'},
                {name:'陈二二',avatar:'',id:'key2',phonetic:'C'},
                {name:'傅志强',avatar:'../assets/head.jpg',id:'key3',phonetic:'F'},
                {name:'关四四',avatar:'../assets/head.jpg',id:'key4',phonetic:'G'},
                {name:'李一一',avatar:'../assets/head.jpg',id:'key5',phonetic:'L'},
                {name:'李二二',avatar:'../assets/head.jpg',id:'key6',phonetic:'L'},
                {name:'钱鑫鑫',avatar:'../assets/head.jpg',id:'key13',phonetic:'QianXinXin'},
                {name:'谭三三',avatar:'../assets/head.jpg',id:'key7',phonetic:'T'},
                {name:'王四四',avatar:'../assets/head.jpg',id:'key8',phonetic:'W'},
                {name:'王一一',avatar:'../assets/head.jpg',id:'key9',phonetic:'W'},
                {name:'赵二二',avatar:'../assets/head.jpg',id:'key10',phonetic:'Z'},
                {name:'张三三',avatar:'../assets/head.jpg',id:'key11',phonetic:'Z'},
                {name:'张四四',avatar:'../assets/head.jpg',id:'key12',phonetic:'ZhangSiSi'}
